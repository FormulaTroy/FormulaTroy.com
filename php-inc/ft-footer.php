      ...
      <div class="row row-cols-1 row-cols-sm-3 g-3">
        <div class="col text-center social-links">
          <p>
            ...
            <a href="https://github.com/FormulaTroy" target="_blank"><i class="bi bi-github"></i> GitHub</a>
          </p>
        </div>
        <div class="col text-center">
          <p class="fs-5">Made with <i class="bi bi-heart-fill"></i></p>
        </div>
        <div class="col text-center">
          <p>
  ...
  <script src="/js/formulatroy.js"></script>
</body>
</html>
